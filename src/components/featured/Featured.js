            ...
            <div className="container">
                ...
                <div className="span-3 img-details">
                    <div className="top">
                        ...
                        <p>House for Sale</p>
                        <p className="price">$2,6677,000</p>
                    </div>
                    <div className="info-grid">
                        ...
                        <div>
                            ...
                            <div className="info">
                                <p className="bold">Bedrooms:</p><p>$14,979/mo</p>
                            </div>
                        </div>
                    </div>
                </div>
                    <div className="span-2 right-img-details">
                        <p>a beatiful modern day home in the city with a full-size pool.</p>
                ...
                <div className="span-3 img-details prder-6">
                    <div className="top">
                        <h2>123 Acme St, Dallas, TX</h2>
                        <p>House for Sale</p>
                        <p className="price">$2,6677,000</p>
